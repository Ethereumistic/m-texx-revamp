...
export function TextileIndustry2() {
  ...
  return (
    <section className="relative py-24 px-4 md:px-6 lg:px-8 overflow-hidden">
      {/* Remove grid background, only keep the gradient overlay */}
                ...
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <motion.div
                      ...
                      className="flex flex-col items-center justify-center space-y-6 relative z-50"
                    >
                    ...
                    >
                      {activeTabData.content.rightContent.type === "chart" &&
                        (activeTabData.content.rightContent.data ? (
                          // Bar Chart
                          <div className="h-[300px] w-full z-50">
                            <ResponsiveContainer width="100%" height="100%">
                              <BarChart
                                layout="vertical"
